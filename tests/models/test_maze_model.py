...
def test_find_4_random_spots_are_empty(maze_object):
    ...
    for element in random_spots:
        assert True == maze_object.check_vacancy(element[0], element[1])
